...
Для этого нам на пару минут придётся стать безжалостным хакером, удаляющим лишнее, открывающим скрытые позможности гита. Выполням следующие шаги:
