...
### [выбираем и настраиваем ВМ для облака v.01](02.fc41.md)

Fedora Core - dev env для проекта

### [правильное рабочее место девопс - персональное облако из KVM+libvirt](01.home.cloud.md)

настраиваем virt-manager и сопутствующие сервисы

### [знакомство с курсом девопс](devops_intro.md)

Разбор веб-сессии, обзор плана курса, учебного проекта

### [программа курса](devops_path.md)

план курса, права на использование лицензия "Creative Commons с ограничениями коммерческого использования [CC BY-NC 4.0 DEED]"
